...
export default function Main() {
    return (
        <>
            ...
            <div className="flex w-screen sm:w-full px-4 md:px-12 flex-col sm:flex-row justify-between">
            ...
            <div className="relative w-full md:px-12 -top-48 left-32">
            ...
            <div className="w-screen bg-black h-[375px] text-white text-center flex flex-col items-center justify-center">
                <h1 className="text-3xl font-bold leading-9 w-[1100px]">“Como a literatura, o amor e a dor, as viagens são uma bela ocasião para nos encontrarmos com nós próprios”</h1>
